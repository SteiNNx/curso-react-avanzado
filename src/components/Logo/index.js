...
const Logo = props => (
    ...
    >
        <defs>
            ...
            >
                <stop offset={0} stopColor="#a206a2" />
                <stop offset={1} stopColor="#ff7e0a" />
            </linearGradient>
            <filter
                ...
                height="300%"
            >
                <feFlood floodColor="#fbe085" result="flood" />
                <feComposite
                    operator="in"
                    in2="SourceAlpha"
                    in="flood"
                    result="shadow"
                />
                <feOffset dx={-2.8} dy={-0.3} in="SourceGraphic" result="offset-1" />
                <feOffset dx={2.8} dy={0.3} in="shadow" result="offset-2" />
                <feMerge>
